...
public class addteacher extends AppCompatActivity {
    private static final String TAG ="addteacher" ;
...
//        }
        if( TextUtils.isEmpty(Sname.getText())){
            ...
            Toast.makeText(getApplicationContext(), "Teacher name is required!", Toast.LENGTH_SHORT).show();
            motherNameEt.setError("Teacher name is required!");
        }
...
//      PreStdAct preStdAct = new PreStdAct();
            ...
            databaseTeacher.child(sid).setValue(teacher);
//            createAccount(email,spass);
    ...
    public void removeStudent(View v){
        if (!TextUtils.isEmpty(Sid.getText().toString())) {
            sid = Sid.getText().toString();
            databaseTeacher.child(sid).setValue(null);
    ...
    private void picDate() {
        ...
        dateView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(addteacher.this, mDateSetListener, year, month, day);
...
//              startActivity(intent);
                        ...
                        Toast.makeText(addteacher.this, "Authentication failed.",
